// Package rating provides an interface to get all ratings for a record, and the controller implements the aggregation logic for them.
package rating

import (
	"context"
	"errors"
	"movistar/rating/internal/repository"
